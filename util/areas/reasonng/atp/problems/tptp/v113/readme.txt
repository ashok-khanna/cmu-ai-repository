  ...
  | and carefully. Last updated Thu Aug 25 08:53:56 +1000 1994              |
  +-------------------------------------------------------------------------+
...
maintained and  distributed from the Department of Computer Science, James Cook 
...
Files
-----
ReadMe-v1.1.3 - This file.
TPTP-v1.1.3.tar.gz - The TPTP problem library, which expands to :
  ...
  + Scripts   - A directory  containing  C shell scripts  for manipulating  the 
                TPTP. The scripts are described in Scripts/ReadMe.
...
TR-v1.1.1.ps.gz - A technical report  describing  the TPTP.  The report  may be 
...
4. The  clauses/literals  may not  be rearranged  without explicit  notice.  If
   rearrangement  is done using  the tptp2X utility,  the rearrangement must be 
   explicitly noted.
...
Copyright
---------
The  TPTP is  copyrighted (c)  1993,  1994,  by  Geoff Sutcliffe  and Christian 
Suttner.   Use  and  verbatim  redistribution   of  the  TPTP  are   permitted.
...
David Plaisted,  Joachim Posegga,  Art Quaife,  Piotr Rudnicki,   Len Schubert,
Alberto Segre*, John Slaney, Mark Stickel*, Bob Veroff, TC Wang.

A  special  acknowledgement  goes  to  Theodor  Yemenis  for  his  help in  the 
construction of the first version of the TPTP library.
