From forbus@ils.nwu.edu Mon Oct 25 14:16:31 EDT 1993
Article: 11288 of comp.lang.lisp
Xref: glinda.oz.cs.cmu.edu comp.ai:19292 comp.lang.lisp:11288 comp.ai.edu:1394
Path: honeydew.srv.cs.cmu.edu!rochester!udel!wupost!math.ohio-state.edu!magnus.acs.ohio-state.edu!usenet.ins.cwru.edu!news.ecn.bgu.edu!anaxagoras.ils.nwu.edu!orac.ils.nwu.edu!forbus
From: forbus@ils.nwu.edu (Ken Forbus)
Newsgroups: comp.ai,comp.lang.lisp,comp.ai.edu
Subject: Code for Building Problem Solvers now available via anonymous ftp
Followup-To: comp.ai
Date: 24 Oct 1993 06:06:15 GMT
Organization: The Institute for the Learning Sciences
Lines: 265
Sender: forbus@orac.ils.nwu.edu (Ken Forbus)
Distribution: world
Message-ID: <2ad60n$gut@anaxagoras.ils.nwu.edu>
NNTP-Posting-Host: orac.ils.nwu.edu
Keywords: problem solving, reasoning, truth-maintenance systems, constraints

We are happy to announce that the code for our book, Building Problem
Solvers, is now available via anonymous ftp.  The details are below,
in a copy of the readme.txt file that comes with the distribution.  We
thank everyone for their interest, encouragement, and patience.

	Ken Forbus and Johan de Kleer

P.S. Building Problem Solvers is published by MIT Press.  The current
schedule indicates that copies of the book should be shipping as of
early November.  To get more information on the book, please try one
of the following media:

	email: 	mitpress-order-inq@mit.edu for inquiries
		mitpress-orders@mit.edu to order

	gopher: gopher.mit.edu

	voice: 	1-800-365-0343 (inside US)
		1-617-625-8569 (outside US)
...
Please see the book "Building Problem Solvers", published by MIT Press,
